...
import './style.css';
import '../../../node_modules/simple-line-icons/css/simple-line-icons.css'; // new path used (via monorep folder structure)

import demoScreen1 from '../../web/images/demo-screen-1.jpg';

const Features = (props) => (
  <section className="features" id="features">
    <div style={{display:"inherit"}} className="container">

      <div className="break"></div>

      <div style={{alignItems:"center", justifyContent:"center"}} className="section-heading text-center">
